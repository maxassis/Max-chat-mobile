...
export default function Notes() {
    return (
        <SafeAreaView className="flex-1">
            ...
            <View className="flex-1 bg-slate-50 px-5 py-5" >
                <Text className="text-xl font-roboto-bold ">Anotações internas</Text>

                <View className="h-9 mt-2 mb-4 flex-row justify-between items-center">
                    <View className="h-7 pl-1 pr-2 border-[0.5px] gap-x-1 flex-row border-slate-500 items-center justify-center " >
                        ...
                        <Text className="text-base text-slate-500">Mostrar mais recentes</Text>
                    </View>
                    ...
                    <View className="w-full mb-3 bg-amber-100 border-2 border-yellow-500 p-5">
                        <View className="flex-row  justify-between items-center ">
                            <View>
                                ...
                                <Text className="font-roboto-bold text-xs">20/03/2024 às 12:15</Text>
                            </View>
                        ...
                        <Text className="mt-5 text-[18px]">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero velit dolores, dolor, amet a aliquid maiores nam rem nihil temporibus repellendus magni voluptas ipsam? A dolores deserunt soluta eos esse?
                        </Text>
