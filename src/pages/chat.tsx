            ...
            {sideMenu && !isKeyboardVisible ? (
              <>
                ...
                <View className="absolute justify-around w-[61px] h-[420px] py-2 items-center bg-white border-[0.5px] border-slate-400 right-0 top-0 ">
                  <TouchableOpacity onPress={() => {setSideMenu(false); navigation.navigate('Informations')}} 
                     className="w-11 h-11 rounded-md border-slate-400 border-[0.8px] items-center justify-center">
                    <Feather name="user" size={30} color={colors.slate[400]} />
                  </TouchableOpacity>

                  <TouchableOpacity onPress={() => {setSideMenu(false); navigation.navigate('Notes')}} 
                      className="w-11 items-center justify-center h-11 rounded-md border-slate-400 border-[0.8px]">
                    <Ionicons
                  ...
                  <TouchableOpacity onPress={() => {setSideMenu(false); navigation.navigate('Funnel')}} 
                      className="w-11 h-11 items-center justify-center rounded-md border-slate-400 border-[0.8px]">
                    <Ionicons
                      name="funnel-outline"
                      size={30}
                      color={colors.slate[400]}
                  ...
                  <TouchableOpacity onPress={() => {setSideMenu(false); navigation.navigate('Chatbot')}} 
                      className="w-11 h-11 items-center justify-center rounded-md border-slate-400 border-[0.8px]">
                    <Octicons
                      name="dependabot"
                      size={30}
                  ...
                  <TouchableOpacity onPress={() => {setSideMenu(false); navigation.navigate('Nps')}} 
                      className="w-11 h-11 items-center justify-center rounded-md border-slate-400 border-[0.8px]">
                    <Feather name="pie-chart" size={30} color={colors.slate[400]} />
                  </TouchableOpacity>

                  <TouchableOpacity onPress={() => {setSideMenu(false); navigation.navigate('Delegated')}} 
                      className="w-11 h-11 items-center justify-center rounded-md border-slate-400 border-[0.8px]">
                    <Feather
                      name="user-plus"
                      size={30}
                  ...
                  <TouchableOpacity onPress={() => {setSideMenu(false); navigation.navigate('Media')}} 
                      className="w-11 h-11 items-center justify-center rounded-md border-slate-400 border-[0.8px]">
                    <Ionicons
                      name="play-outline"
                      size={30}
